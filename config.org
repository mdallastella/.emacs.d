  ...
  (use-package org
    ...
    (setq org-directory "~/org/"
          ...
          org-refile-targets `((,(my/org-location "todo.org") . (:maxlevel . 2))
                               ...
                               (,(directory-files (my/org-location "aree") t "\\.org$") . (:maxlevel . 3))
                               (,(directory-files (my/org-location "risorse") t "\\.org$") . (:maxlevel . 3)))
...
#+begin_src emacs-lisp
  (use-package consult-notes
    ...
    (setq consult-notes-use-rg t
          ...
          consult-notes-file-dir-sources `(("Aree" ?a ,(my/org-location "aree/"))
                                           ("Risorse" ?a ,(my/org-location "risorse/"))))
