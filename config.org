...
#+end_src
** ECA
[[https://github.com/editor-code-assistant/eca-emacs][ECA]]: (Editor Code Assistant) Emacs is an AI-powered pair-programming client for
Emacs.
...
#+begin_src emacs-lisp
  (use-package eca
    ...
    :bind (("C-c a a" . eca)
           ("C-c a q" . eca-stop))
    :config
    (setq eca-chat-custom-model "openrouter/google/gemini-2.5-flash"))
#+end_src
