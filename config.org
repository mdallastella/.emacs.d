...
#+begin_src emacs-lisp
  (use-package mason
    :bind
    (("C-c u l l" . mason-manager)
     ("C-c u l d" . mason-doctor)
     ("C-c u l u" . mason-update))
    :hook
...
#+begin_src emacs-lisp
  (use-package flycheck-clj-kondo
    :hook ((clojure-mode . 'flycheck-clj-kondo)))
...
#+begin_src emacs-lisp
  ...
  (use-package vue-ts-mode
    :defer t
    :vc (vue-ts-mode :url "https://github.com/8uff3r/vue-ts-mode"))
