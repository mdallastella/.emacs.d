...
#+begin_src emacs-lisp
  (use-package org
    ...
    (setq org-directory "~/org"
          ...
          org-agenda-files `(,(directory-files "~/org" t "\\.org$") . (:maxlevel . 2))
...
#+begin_src emacs-lisp
  (use-package consult-notes
    ...
    (setq consult-notes-use-rg t
          consult-notes-file-dir-sources '(("Notes" ?b "~/org/"))))
#+end_src
...
#+begin_src emacs-lisp
  (use-package org-re-reveal
    :after ox
    :config
    (setq org-re-reveal-root "https://cdnjs.cloudflare.com/ajax/libs/reveal.js/4.6.1/"
          org-re-reveal-revealjs-4-file "reveal.js"
