...
**  Try
[[https://github.com/larstvei/try][Try]] is a package that allows you to try out Emacs packages without installing
them.
#+begin_src emacs-lisp
  (use-package try
    :bind
...
** Aider
[[https://github.com/MatthewZMD/aidermacs][Aidermacs: AI Pair Programming in Emacs]]
#+begin_src emacs-lisp
  (use-package aidermacs
    ...
    :config
    (setenv "ANTHROPIC_API_KEY" my/anthropic-api-key)
