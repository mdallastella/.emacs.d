...
#+begin_src emacs-lisp
  ...
  ;;          "* %?\n%L")
  ;;         ("P" "New Project" entry (file "projects.org")
  ...
  (setq org-capture-templates
        '(("t" "Todo" entry (function my/today-file)
          ...
          ("i" "Inbox" entry (file "pages/inbox.org")
           "* [[%<%Y-%m-%d>]]: - %?")
          ("p" "Project todo" entry (function (lambda () (my/org-headings "progetti")))
           "* TODO %?\n")
          ("a" "Area note" entry (function (lambda () (my/org-headings "aree")))
           "* %?\n")))
#+end_src
