...
*** Read file to string
#+begin_src emacs-lisp
  (defun my/read-file-contents (file)
...
#+end_src
*** Notifications
Use ~notify-send~ to send notifications.
#+begin_src emacs-lisp
...
** Instapaper
[[https://github.com/emacsmirror/insta-pocket][insta-pocket.el]]: Instapaper client for Emacs
#+begin_src emacs-lisp
  (use-package insta-pocket
    :config
    (setq insta-pocket-consumer-key my/instapaper-key
          insta-pocket-consumer-secret my/instapaper-secret))
#+end_src
...
** gptel-magit
#+begin_src emacs-lisp
  (defun my/gptel-magit-set-prompt (filename)
