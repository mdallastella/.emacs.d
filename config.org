...
#+begin_src emacs-lisp
  (use-package mise
    :vc (:fetcher github :repo vitallium/mise.el)
    :config
...
** Logview
[[https://github.com/doublep/logview][Logview]] major mode for Emacs provides syntax highlighting, filtering and other
features for various log files.
...
#+begin_src emacs-lisp
  (use-package eglot
    :pin gnu-devel
    :hook
    ((clojure-mode clojurescript-mode js2-mode rjsx-mode python-ts-mode) . eglot-ensure)
    :bind
...
#+begin_src emacs-lisp
  (defun my/all-org-files ()
    (-concat (directory-files "~/org" t "\\.org$")
             (directory-files-recursively "~/org/funes" "\\.org$" nil nil t)))
  ...
  (use-package org
    ...
    (setq org-directory "~/org"
          ...
          org-agenda-files (my/all-org-files)
          ...
          org-refile-targets `((,(directory-files "~/org" t "\\.org$") . (:maxlevel . 2))
                               (,(directory-files-recursively "~/org/funes" "\\.org$" nil nil t) . (:maxlevel . 2)))
...
#+begin_src emacs-lisp
  (use-package consult-notes
    ...
    (setq consult-notes-use-rg t
          consult-notes-file-dir-sources '(("Backlog" ?b "~/org/")
                                           ("Projects" ?p "~/org/funes/progetti/")
                                           ("Areas" ?a "~/org/funes/aree/")
                                           ("Resources" ?r "~/org/funes/risorse/"))))
#+end_src
