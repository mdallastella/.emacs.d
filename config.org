...
#+end_src
** org-mode
Org mode settings for an integration with [[https://logseq.com/][Logseq]]
...
#+begin_src emacs-lisp
  ...
  (use-package org
    ...
    (setq org-directory "~/org/"
          ...
          org-default-notes-file (my/org-location "pages/inbox.org")
  ...
  (setq org-capture-templates
        '(("t" "Todo" entry (function my/today-file)
          ...
          ("i" "Inbox" entry (file "pages/inbox.org")
           "* [[%<%Y-%m-%d>]]: - %?")
          ("P" "Project" entry (file "pages/progetti.org")
           "* %? %^G\n" . (:level 1 :empty-lines-before 1))
          ("p" "Project todo" entry (file+function "pages/progetti.org" consult-org-heading)
           "* TODO %?\n" . (:level 1 :empty-lines-before 1))))
#+end_src
