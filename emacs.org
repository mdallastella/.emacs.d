   ...
   #+BEGIN_SRC emacs-lisp
	...
	(cider-repl-mode . subword-mode))
       ...
       (:map cider-repl-mode-map
	     ("C-c c b" . cider-repl-clean-buffer))
...
** Global Todotxt
   #+BEGIN_SRC emacs-lisp
     (global-set-key (kbd "C-c t t") (lambda () (interactive) (find-file "/home/mds/cloud/marco/todo.txt")))
   #+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package todotxt
    :ensure t
    :config
    (validate-setq todotxt-file "/home/mds/cloud/marco/todo.txt"))
#+END_SRC
