...
** Shell environment
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (use-package keychain-environent
       :ensure t
       :init
...
** Global Todotxt
   #+BEGIN_SRC emacs-lisp
     (global-set-key (kbd "C-c t t") (lambda () (interactive) (find-file "/home/mds/cloud/mds/todo.txt")))
   #+END_SRC
...
** Todotxt config
   I use todotxt for my ZTD stuff.
#+BEGIN_SRC emacs-lisp
  (use-package todotxt
    :ensure t
    :mode
    ("todo.txt" . todotxt-mode)
    :config
    (validate-setq todotxt-file "/home/mds/cloud/mds/todo.txt"))
#+END_SRC
